...
const DetailMenuSoup = () => {
  ...
  useEffect(() => {
    if (soup) {
      ...
      const isAlreadyFavorite = favorites.some(item => item.id === soup.id && item.type === 'soup');
  ...
  const handleFavoriteToggle = () => {
    ...
    if (isFavorite) {
      const updatedFavorites = favorites.filter(item => !(item.id === soup.id && item.type === 'soup'));
    ...
    return (
      <div className="w-full min-h-screen flex items-center justify-center bg-gradient-to-b from-orange-50 to-white">
        <div className="text-center">
          ...
          <Link to="/MenuSoup" className="text-orange-600 hover:text-orange-700 font-semibold">
            ← Back to Soups
          </Link>
        </div>
      </div>
  ...
  const addToCart = () => {
    ...
    const existingItemIndex = cart.findIndex(item => item.id === soup.id && item.type === 'soup');
  ...
  return (
    <>
      ...
      <Link to="/MenuSoup" className="inline-flex items-center gap-2 text-orange-600 hover:text-orange-700 font-semibold mb-8 group">
          ...
          <div>
            <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10">
              ...
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-gray-600 font-medium">(4.9) • 156 Reviews</span>
              </div>
              ...
              <div className="mb-8">
                <div className="flex items-baseline gap-3">
                  ...
                  <span className="text-gray-500 text-lg line-through">${(soup.price * 1.5 * quantity).toFixed(2)}</span>
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-gray-500 ml-4">Available: <span className="font-semibold text-green-600">{soup.qty || 10} items</span></span>
                </div>
              </div>
            ...
            <div className="mt-6 bg-gradient-to-r from-orange-100 to-red-100 rounded-2xl p-6">
              ...
              <p className="text-gray-700">Perfect soup for a cozy meal. Served hot and fresh!</p>
            </div>
          </div>
        </div>
      </div>

      ...
      <div className='w-full h-auto py-16 px-6 md:px-14'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-gray-600 text-lg max-w-2xl mx-auto'>
            End your meal with our delightful traditional desserts
          </p>
        ...
        <div className='max-w-2xl mx-auto mb-8'>
          <div className='relative'>
            ...
            <input
              ...
              placeholder='Search desserts by name, category, or description...'
          ...
          <p className='text-sm text-gray-500 mt-2 text-center'>
            Found {filteredDesserts.length} {filteredDesserts.length === 1 ? 'dessert' : 'desserts'}
          ...
          {currentItems.length > 0 ? (
            currentItems.map((s, index) => (
              <div
                ...
                key={s.id}
                className='w-full md:w-[48%] lg:w-[23%] h-[520px] bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 ease-in-out group hover:-translate-y-3 border border-gray-100'
              >
                {/* image */}
                ...
                <div className='w-full h-[40%] p-5 bg-white flex flex-col justify-between'>
                  ...
                  <Link
                    to={`/MenuDessert/${s.id}`}
                    className='block text-center w-full px-6 py-3 rounded-xl text-white bg-gradient-to-r from-orange-500 to-red-500 
            ...
            <div className='w-full text-center py-20'>
              ...
              <h3 className='text-2xl font-bold text-gray-900 mb-2'>No desserts found</h3>
